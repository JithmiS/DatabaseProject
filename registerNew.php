...
if (isset($_POST['register'])) {
    ...
    $reqFields = array('firstname', 'lastname', 'email', 'address','contact_number', 'position', 'password','position');
												...
												<form method="post" action="registerNew.php">
													<div class="row uniform">
														...
														<div class="12u$">
															...
															<select name='position' onchange="check()">
														...
														<div class="12u$">
															<label for="position"><b>City Store:</b> </label>
															<select disabled name='city_store_id'>
																<option value='not selected' >Not selected</option>
